...
IL_005d_1:
			...
			}
			{
				...
				int64_t L_22 = __this->____unconsumedBytes;
				int64_t L_23 = V_6;
				__this->____unconsumedBytes = ((int64_t)il2cpp_codegen_subtract(L_22, L_23));
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_24 = ___2_examinedSegment;
				NullCheck(L_24);
				int64_t L_25;
				L_25 = ReadOnlySequenceSegment_1_get_RunningIndex_mC1F25977D805187711D9ED4801A2E6B3B31371AC_inline(L_24, ReadOnlySequenceSegment_1_get_RunningIndex_mC1F25977D805187711D9ED4801A2E6B3B31371AC_RuntimeMethod_var);
				int32_t L_26 = ___3_examinedIndex;
				__this->____lastExaminedIndex = ((int64_t)il2cpp_codegen_add(L_25, ((int64_t)L_26)));
				int64_t L_27;
				L_27 = Pipe_get_ResumeWriterThreshold_m1E3B9BD5C95B12AD1CE32C4306E3FA60919CF6A2(__this, NULL);
				if ((((int64_t)L_21) < ((int64_t)L_27)))
				{
					goto IL_00c2_1;
				}
			}
			{
				int64_t L_28 = __this->____unconsumedBytes;
				int64_t L_29;
			...
			{
				PipeAwaitable_tCDAF4E520A7FA1E04D8CD12468288E3C44E61ECE* L_30 = (PipeAwaitable_tCDAF4E520A7FA1E04D8CD12468288E3C44E61ECE*)(&__this->____writerAwaitable);
				PipeAwaitable_Complete_mCD976D74FF4AA8B2D65AF1F3131F53085B679227_inline(L_30, (&V_2), NULL);
			}

IL_00c2_1:
			{
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_31 = ___0_consumedSegment;
				if (!L_31)
				{
					goto IL_015f_1;
				}
			...
			{
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_32 = __this->____readHead;
				if (L_32)
				{
					goto IL_00da_1;
				}
...
IL_00da_1:
			{
				...
				V_1 = L_33;
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_34 = ___0_consumedSegment;
				(&V_0)->___returnEnd = L_34;
				Il2CppCodeGenWriteBarrier((void**)(&(&V_0)->___returnEnd), (void*)L_34);
				int32_t L_35 = ___1_consumedIndex;
				U3CU3Ec__DisplayClass67_0_tDD7FF7D1DF0032D2CAE4642FD92309865A761B7C L_36 = V_0;
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_37 = L_36.___returnEnd;
				NullCheck(L_37);
				int32_t L_38;
				L_38 = BufferSegment_get_Length_m50DFF642D8E228B9E7A6B25F54B3D6FF9F7C3E35(L_37, NULL);
			...
			{
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_39 = __this->____writingHead;
				U3CU3Ec__DisplayClass67_0_tDD7FF7D1DF0032D2CAE4642FD92309865A761B7C L_40 = V_0;
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_41 = L_40.___returnEnd;
				if ((((RuntimeObject*)(BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373*)L_39) == ((RuntimeObject*)(BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373*)L_41)))
				{
					goto IL_010f_1;
				}
			}
...
IL_010f_1:
			{
				int32_t L_42 = __this->____writingHeadBytesBuffered;
				if (L_42)
				{
					goto IL_0141_1;
				}
			...
			{
				PipeOperationState_t00BBB1EDE2E82F3ED67A0290494096B3A587E325* L_43 = (PipeOperationState_t00BBB1EDE2E82F3ED67A0290494096B3A587E325*)(&__this->____operationState);
				bool L_44;
				L_44 = PipeOperationState_get_IsWritingActive_mBF1D9C8EBC2FA5CDE6AA16E260C16DC3EE06A38D(L_43, NULL);
				if (L_44)
				{
					goto IL_0141_1;
				}
			}
			{
				...
				Memory_1_tB7CEF4416F5014E364267478CEF016A4AC5C0036* L_45 = (Memory_1_tB7CEF4416F5014E364267478CEF016A4AC5C0036*)(&__this->____writingHeadMemory);
				il2cpp_codegen_initobj(L_45, sizeof(Memory_1_tB7CEF4416F5014E364267478CEF016A4AC5C0036));
				Pipe_U3CAdvanceReaderU3Eg__MoveReturnEndToNextBlockU7C67_0_m1AC19462597E4CBB982E5FC31303B8A39890D7E1(__this, (&V_0), NULL);
				goto IL_015f_1;
			}
...
IL_0141_1:
			{
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_46 = ___0_consumedSegment;
				__this->____readHead = L_46;
				Il2CppCodeGenWriteBarrier((void**)(&__this->____readHead), (void*)L_46);
				int32_t L_47 = ___1_consumedIndex;
				__this->____readHeadIndex = L_47;
				goto IL_015f_1;
			}
...
IL_0151_1:
			{
				...
				__this->____readHead = L_48;
				Il2CppCodeGenWriteBarrier((void**)(&__this->____readHead), (void*)L_48);
				int32_t L_49 = ___1_consumedIndex;
				__this->____readHeadIndex = L_49;
			}
...
IL_015f_1:
			...
			{
				PipeCompletion_t4D0BFCFAFD54514A1406634F89B9077E54702848* L_51 = (PipeCompletion_t4D0BFCFAFD54514A1406634F89B9077E54702848*)(&__this->____writerCompletion);
				il2cpp_codegen_runtime_class_init_inline(PipeCompletion_t4D0BFCFAFD54514A1406634F89B9077E54702848_il2cpp_TypeInfo_var);
				bool L_52;
				L_52 = PipeCompletion_get_IsCompleted_m1A2216E4286B87B45DD8AFEE159B328062BE9F79(L_51, NULL);
				if (L_52)
				{
					goto IL_0191_1;
				}
			...
			{
				PipeAwaitable_tCDAF4E520A7FA1E04D8CD12468288E3C44E61ECE* L_53 = (PipeAwaitable_tCDAF4E520A7FA1E04D8CD12468288E3C44E61ECE*)(&__this->____readerAwaitable);
				PipeAwaitable_SetUncompleted_mC3B615F389C96AFA5C9D9E63856E4F187E4E520D_inline(L_53, NULL);
				goto IL_0191_1;
			}

IL_017d_1:
			{
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_54 = V_1;
				NullCheck(L_54);
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_55;
				L_55 = BufferSegment_get_NextSegment_m59FAA272F7120524F4D2E806A7541FBD0D6EFFA5_inline(L_54, NULL);
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_56 = V_1;
				NullCheck(L_56);
				BufferSegment_Reset_m37BBCF32F50BAF795C7BF21EAA89CC314F13BE47(L_56, NULL);
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_57 = V_1;
				Pipe_ReturnSegmentUnsynchronized_mD4CCCF3C58AC4CA2CB2F98BB34B8AE9760D5C7E1(__this, L_57, NULL);
				V_1 = L_55;
			}
...
IL_0191_1:
			...
			}
			{
				...
				U3CU3Ec__DisplayClass67_0_tDD7FF7D1DF0032D2CAE4642FD92309865A761B7C L_60 = V_0;
				BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373* L_61 = L_60.___returnEnd;
				if ((!(((RuntimeObject*)(BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373*)L_59) == ((RuntimeObject*)(BufferSegment_t8402FB1D4C33151DAC1ED8B1492A9BD386224373*)L_61))))
				{
					goto IL_017d_1;
				}
			}
...
IL_019d_1:
			{
				PipeOperationState_t00BBB1EDE2E82F3ED67A0290494096B3A587E325* L_62 = (PipeOperationState_t00BBB1EDE2E82F3ED67A0290494096B3A587E325*)(&__this->____operationState);
				PipeOperationState_EndRead_m592D8ECEEF5BD6E0E527C028B0618E13AC20A17B_inline(L_62, NULL);
				goto IL_01b5;
			}
		}
		catch(Il2CppExceptionWrapper& e)
...
IL_01b5:
	{
		PipeScheduler_t074366BD2A9BE3379DA6334FD2AB025E90E6CCF8* L_63;
		L_63 = Pipe_get_WriterScheduler_m42E84DF46B1693678AECCFE6FE505A9A7983A79E(__this, NULL);
		il2cpp_codegen_runtime_class_init_inline(Pipe_tC347D1B1656618ADDE5D79937D1FAF9A80D225ED_il2cpp_TypeInfo_var);
		Pipe_TrySchedule_m053B240484995D4ADEF243ADC9A02EAB00A01D6C_inline(L_63, (&V_2), NULL);
	}
